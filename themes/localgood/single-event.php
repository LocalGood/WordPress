    ...
    <div class="c-contents_wrapper c-w1096">
        ...
        <?php if (have_posts()): the_post();
            ...
            <div class="c-page_title_wrapper">
                <h2 class="c-page_title c-title05"><img src="<?php echo get_option('lg_config__page_ttl_prefix'); ?>">イベント
                </h2>
            </div>
            ...
            ?>
            <a class="c-back_button" href="<?php echo home_url('/event/'); ?>">イベント一覧へ戻る</a>
        <?php endif; ?>
