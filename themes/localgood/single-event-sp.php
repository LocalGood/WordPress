    ...
    <?php if (have_posts()): the_post();
        ...
        <div class="contents_wrapper">
            <div class="inner">
                        ...
                        <div class="common_single_parts_info__sns">
                            <?php if (!empty($sns_accounts['facebook'])) : ?>
                                <a href="<?php echo $sns_accounts['facebook']; ?>">
                                    <img src="<?php bloginfo('stylesheet_directory'); ?>/images/writer_fb_on.png"
                                         alt="">
                                </a>
                            <?php else : ?>
                            ...
                            <?php if (!empty($sns_accounts['twitter'])) : ?>
                                <a href="<?php echo $sns_accounts['twitter']; ?>">
                                    <img src="<?php bloginfo('stylesheet_directory'); ?>/images/writer_tw_on.png"
                                         alt="">
                                </a>
                            <?php else : ?>
                ...
                <a href="<?php echo home_url('/event/'); ?>" class="return_news_list">
                    イベント一覧へ戻る
                </a>
            </div><!-- .inner -->
            <?php related_posts(); ?>
