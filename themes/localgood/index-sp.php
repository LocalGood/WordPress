            ...
            for ($i = 0; $i < 3; $i++) :
                ...
                if (('tweet' === $latest_posts[$i]->post_type || 'subject' === $latest_posts[$i]->post_type)) {
	                ...
	                if ( empty( $attached_medias_obj ) ) {
		                $thumbnail = get_stylesheet_directory_uri() . '/images/lg-noimage-sp.jpg';
	                } else {
            ...
            <section class="top_page__box01__inner02">
                ...
                <section>
                    ...
                    <div class="text_wrapper02">
                        ...
                        <a href="<?php echo esc_attr(get_option('lg_config__goteo_baseurl', false)); ?>"
                           class="link_button01">
                            地域に参加する
                        </a>
                    </div>
            ...
            if (!empty($_promotes)) {
                foreach ($_promotes as $_promo) {
                    ...
                    <div class="project_box__part">
                        <iframe class="autoHeight" frameborder="0" width="100%" height="480px"
                                src="<?php echo $_prj_url; ?>"
