        ...
        <form action="" method="post" id="post_subject" name="post_subject"
            ...
            <section class="submit_subject__form_area">
                ...
                if ($status == 'input') :
                    ...
                    <section class="form_block">
                        ...
                        <p class="form_block__title_sup theme">
                            一覧から選択してください。
                        </p>
                    ...
                    <section class="form_block">
                        ...
                        <p class="form_block__title_sup <?php echo $notice_class; ?> content">
                            課題の内容や発生場所を入力してください。
                        </p>
                    ...
                    <section class="form_block">
                        <h2 class="form_block__title">画像を添付する</h2>
                    ...
                    <section class="form_block">
                        ...
                        <div class="submit_subject__address_search">
                            ...
                            <button type="submit" id="address_search_exec" class="form_block__address_search_exec">
                                検索する
                            </button>
            ...
            <?php if ('input' === $status) : ?>
                <div class="form_block c-clearfix">
                    <button class="submit_button" type="submit" name="stage" id="submitSubject" value="submit">投稿する
                    </button>
                </div>
            <?php endif; ?>
        </form>
