			...
			<dl>
				...
				<dd>
					<img src="<?php echo get_option( 'lg_config__main_logo' ); ?>"
						 class="media-preview media-preview_main_logo">
					<input type="text" name="lg_config__main_logo"
						   value="<?php echo get_option( 'lg_config__main_logo' ); ?>"
						   class="media-url_main_logo input_text_70p">
				...
				<dd>
					<img src="<?php echo get_option( 'lg_config__home_wallpaper' ); ?>"
						 class="media-preview media-preview_home_wallpaper">
